 ...
 */
module.exports = ({ prod = false, name, exposes, sharedLibrariesEager = true, alias = {}, publicPath, destination, plugins = [], overrides = {} }) => ({
    target: "web",
    mode: "development",
    entry: {},
    optimization: {
        ...
        rules: [
            {
                test: /\.css$/,
                use: [
                    "style-loader", // because HMR do not work with mini-css plugin
                    {
                        loader: 'css-loader'
                    }
                ]
